...
## Console Texture
- Make an sonic texture and model. You may use any of the variants as a base, but remember whatever you borrow as a base cannot be claimed as your own, used in any other media (without permission from Loqor), or distributed.
...
> }
  ...
  "id": "(namespace):(console_texture_name)",
  "models": {
    "inactive": "(namespace):(console_texture_name)",
    "interaction": "(namespace):(console_texture_name)",
    "overload": "(namespace):(console_texture_name)",
    "scanning": "(namespace):(console_texture_name)",
    "tardis": "(namespace):(console_texture_name)"
  }
}
> ```
